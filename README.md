...
![slack](https://img.shields.io/badge/slack-wso2--apim-blueviolet)
![StackOverflow](https://img.shields.io/badge/stackoverflow-wso2am-orange)
![Jenkins Build](https://img.shields.io/jenkins/build?jobUrl=https%3A%2F%2Fwso2.org%2Fjenkins%2Fview%2Fdocs%2Fjob%2Fdocs%2Fjob%2Fdocs-apim%2F)
...
2. Fork this repository, make your changes, and send in a pull request (PR). Make sure you are contributing to the correct branch (for example, if your change is relevant to WSO2 API-M 4.6.0 documentation, you should commit your changes to the 4.6.0 branch).
...
3. Send multiple pull requests to all the relevant branches.
    ...
    For example, if the latest API-M release is 4.6.0, and if your change is relevant to API-M 4.5.0, 4.4.0, 4.3.0, and 4.2.0, send PRs to the 4.5.0, 4.4.0, 4.3.0, 4.2.0, and the master branches.
