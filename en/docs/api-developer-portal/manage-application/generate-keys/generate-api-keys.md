...
!!! note
     Before you begin, make sure to follow [steps 1 and 2 in Configure Okta as a Key Manager]({{base_path}}/api-security/key-management/third-party-key-managers/configure-okta-connector.md) guide.
...
!!! note
     Before you begin, make sure to follow [steps 1 and 2 in Configure Keycloak as a Key Manager]({{base_path}}/api-security/key-management/third-party-key-managers/configure-keycloak-connector.md) guide.
