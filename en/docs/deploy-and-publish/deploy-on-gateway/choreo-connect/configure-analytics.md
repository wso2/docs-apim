...
WSO2 Choreo Connect can publish events to the Choreo platform to generate analytics. The following subsections explain Analytics for Choreo Connect in detail and how you could generate useful analytics to gain important insights into the APIs deployed on the Choreo Connect. 
