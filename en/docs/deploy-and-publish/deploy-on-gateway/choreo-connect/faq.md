...
Scope validation, subscription validation and custom claims mapping. Refer to the [API Authorization]({{base_path}}/deploy-and-publish/deploy-on-gateway/choreo-connect/security/api-authorization/scope-validation/) for more information.
