...
!!! Important
    If you are using a distributed APIM setup, public cert of APIM publisher node (certificate should be in PEM format) needs to be imported to truststore in Choreo Connect. Also it should be registered as a new token service under security configuration in config.toml. Sample configuration is defined in below.
