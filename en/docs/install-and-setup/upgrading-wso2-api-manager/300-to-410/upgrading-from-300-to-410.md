...
The following information describes how to upgrade your API Manager server **from APIM 3.0.0 to 4.1.0**.
...
6. If you already have used secondary user stores in API-M 3.0.0, you have to copy the user store file created inside the old API-M version to the new APIM version.
...
1.  Make sure you backed up all the databases in APIM 3.0.0
