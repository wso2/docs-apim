...
!!! Attention "If you are using WSO2 Identity Server (WSO2 IS) as a Key Manager"
    ...
    Follow the instructions in [Upgrading WSO2 IS as the Key Manager to 5.11.0]({{base_path}}/install-and-setup/upgrading-wso2-is-as-key-manager/upgrading-from-is-590-to-is-5110).

This page provides details about the behavioral changes from WSO2 API Manager Server 3.0.0 to 4.1.0
