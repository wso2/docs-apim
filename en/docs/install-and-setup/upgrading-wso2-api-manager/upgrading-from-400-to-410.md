...
5. Download WSO2 API-M Server 4.1.0 and unzip it in the <API-M_4.1.0_HOME> directory.
...
-   [Step 6 - Re-Index the API artifacts](#step-6-re-Index-the-api-artifacts)
...
### Step 6: Re-Index the API artifacts
