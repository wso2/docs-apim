...
!!! note
    If you are using WSO2 Identity Server (WSO2 IS) as a Key Manager, follow the instructions in [Upgrading WSO2 IS as the Key Manager to 5.9.0](../upgrading-wso2-is-as-key-manager/upgrading-from-is-km-510-to-590.md).
...
!!! note
    It is not possible to directly upgrade from WSO2 API Manager 1.10.0 to 3.0.0.
...
After you have successfully migrated your current WSO2 API-M version to 2.6.0, upgrade from API-M 2.6.0 to API-M 3.0.0. For more information, see [Upgrading API Manager from 2.6.0 to 3.0.0](../upgrading-wso2-api-manager/upgrading-from-260-to-300.md).
