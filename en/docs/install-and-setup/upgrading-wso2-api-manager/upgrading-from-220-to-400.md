...
6.  Migrate the API Manager artifacts.
    ...
    3. Prior to API-M migration, run the below command to execute the pre-migration step that will validate your old data.
        ...
        ``` tab="Linux / Mac OS"
        sh api-manager.sh -DmigrateFromVersion=2.2.0 -DrunPreMigration
        ```

        ``` tab="Windows"
        api-manager.bat -DmigrateFromVersion='2.2.0' -DrunPreMigration
        ```
        ...
        !!! note "If you want to save the invalid API definitions"
            ...
            ```tab="Linux / Mac OS"
            sh api-manager.sh -DmigrateFromVersion=2.2.0 -DrunPreMigration -DsaveInvalidDefinition
            ```

            ``` tab="Windows"
            api-manager.bat -DmigrateFromVersion='2.2.0' -DrunPreMigration -DsaveInvalidDefinition
            ```
    ...
    4.  Start the API-M server as follows.
        ...
        ``` tab="Linux / Mac OS"
        sh api-manager.sh -DmigrateFromVersion=2.2.0
        ```

        ``` tab="Windows"
        api-manager.bat -DmigrateFromVersion=2.2.0
        ```
