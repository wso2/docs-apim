...
<div class="admonition info">
    ...
    <ol>
        <li><strong>For All-in-One deployment:</strong> Simply install WSO2 API Manager 4.3.0 in place of your existing 4.2.0 installation. The existing database and configuration will be automatically compatible.</li>
        <li><strong>For distributed deployments:</strong> Replace each API Manager component (Control Plane, Gateway, Traffic Manager) with the corresponding 4.3.0 version while maintaining the same deployment architecture and profiles.</li>
        <li><strong>No migration scripts required:</strong> Unlike other version upgrades, the 4.2.0 to 4.3.0 upgrade does not require running any database migration scripts or data transformation utilities.</li>
    </ol>
</div>
