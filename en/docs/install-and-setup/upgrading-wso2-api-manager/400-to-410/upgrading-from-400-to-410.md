...
5.  Next you need to run the API-M migration client to do the data migration. 
    ...
    Start the API Manager server to migrate the API Manager components as follows.
