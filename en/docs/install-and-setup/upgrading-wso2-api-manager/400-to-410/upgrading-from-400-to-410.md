...
3. Copy the [org.wso2.carbon.apimgt.migrate.client-4.1.0.x.jar]({{base_path}}/assets/attachments/install-and-setup/migration/org.wso2.carbon.apimgt.migrate.client-4.1.0.36.jar) file into the `<API-M_4.1.0_HOME>/repository/components/dropins` directory.
