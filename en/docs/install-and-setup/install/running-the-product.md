...
WSO2 API Manager has several web portals such as Management Console, API Publisher and Developer Portal. You can refer to the below topics to learn about accessing those.
