...
To upgrade to the current API Manager component from a previous version, see **[Upgrade WSO2 API Manager]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-api-manager/)**.
