...
The following information describes how to upgrade your **WSO2 API Manager (WSO2 API-M)** environment **from APIM 2.2.0 to 4.0.0** when **WSO2 Identity Server (WSO2 IS)** is the **Key Manager** in the pre-migrated setup.
...
!!! note
    -   You can follow the below information in either one of the following situations:
        ...
        -   You are currently using a pre-packaged WSO2 Identity Server as Key Manager 5.5.0 distribution.

-   [Step 1 - Upgrade IS as Key Manager 5.5.0 to IS 5.11.0](#step-1-upgrade-is-as-key-manager-550-to-is-5110)
-   [Step 2 - Upgrade API Manager 2.2.0 to 4.0.0](#step-2-upgrade-api-manager-220-to-400)

## Step 1 - Upgrade IS as Key Manager 5.5.0 to IS 5.11.0

- [Step A - Setup IS 5.11.0 as a Key Manager](#step-a-setup-is-5110-as-a-key-manager)
- [Step B - Migrate IS from 5.5.0 to 5.11.0](#step-b-migrate-is-from-550-to-5110)
...
### Step B - Migrate IS from 5.5.0 to 5.11.0
...
## Step 2 - Upgrade API Manager 2.2.0 to 4.0.0

Follow the steps mentioned in [Upgrading API-M from 2.2.0 to 4.0.0]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-220-to-400/) to upgrade your API-M environment from 2.2.0 to 4.0.0.

!!! important

    -   When following guidelines under [Step 1 - Migrate the API Manager configurations]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-220-to-400/#step-1-migrate-the-api-manager-configurations), make sure to add
    ...
    -   When following guidelines under [Step 2 - Upgrade API Manager to 4.0.0]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-220-to-400/#step-2-upgrade-api-manager-to-400), make sure you **SKIP** the following
    steps.

        -   **Step 3** to upgrade the `WSO2AM_DB` from 2.2.0 to 4.0.0. You have already done this in Step 1 of [Step A - Setup IS 5.11.0 as a Key Manager]({{base_path}}/install-and-setup/upgrading-wso2-is-as-key-manager/upgrading-from-is-km-550-to-is-5110/#step-a-setup-is-5110-as-a-key-manager).
        -   **Step 5** to upgrade identity component in API-M from 5.5.0 to 5.11.0. You have already done this in Step 2 of [Step A - Setup IS 5.11.0 as a Key Manager]({{base_path}}/install-and-setup/upgrading-wso2-is-as-key-manager/upgrading-from-is-km-550-to-is-5110/#step-a-setup-is-5110-as-a-key-manager).

    - After configuring WSO2 IS as the **Resident Key Manager** and before starting the API-M 4.0.0 server for the first time in **Step 6** under [Step 2 - Upgrade API Manager to 4.0.0]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-220-to-400/#step-2-upgrade-api-manager-to-400), make sure you have already started WSO2 IS 5.11.0.
