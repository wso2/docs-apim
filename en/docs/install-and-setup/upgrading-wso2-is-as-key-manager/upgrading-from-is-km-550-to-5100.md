...
The following information describes how to upgrade your **WSO2 API Manager (WSO2 API-M)** environment **from APIM 2.2.0 to 3.2.0** when **WSO2 Identity Server (WSO2 IS)** is the **Key Manager** in the pre migrated setup.
...
-   [Step 1 - Upgrade IS as Key Manager 5.5.0 to IS 5.10.0](#step-1-upgrade-is-km)
-   [Step 2 - Upgrade API Manager 2.2.0 to 3.2.0](#step-2-upgrade-api-manager)

## Step 1 - Upgrade IS as Key Manager 5.5.0 to IS 5.10.0

- [Step A - Setup IS 5.10.0 as a Key Manager](#step-a-setup-is-as-km)
- [Step B - Migrate IS from 5.5.0 to 5.10.0](#step-b-migrate-is)
...
### Step B - Migrate IS from 5.5.0 to 5.10.0

1. Follow Step 2 and 3 under [Step 2 - Upgrade API Manager to 3.2.0]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-300-to-320/#step-2-upgrade-api-manager-to-320) to backup and upgrade the WSO2 API-M `WSO2AM_DB` from 2.2.0 to 3.2.0. This will be used as the `identity_db` in IS 5.10.0.

2. Folllow the guidelines in [WSO2 IS 5.10.0 migration guide](https://is.docs.wso2.com/en/5.10.0/setup/migrating-to-5100/) to migrate your current IS as KM 5.5.0 distribution to IS 5.10.0.
...
## Step 2 - Upgrade API Manager 2.2.0 to 3.2.0

Follow the steps mentioned in [Upgrading API-M from 2.2.0 to 3.2.0]({{base_path}}/install-and-setup/upgrading-wso2-api-manager/upgrading-from-300-to-320/) to upgrade your API-M environment from 2.2.0 to 3.2.0.
...
!!! important
    ...
    steps.
        ...
        -   **Step 3** to upgrade the `WSO2AM_DB` from 2.2.0 to 3.2.0. You have already done this in Step 1 of [Step A - Setup IS 5.10.0 as a Key Manager]({{base_path}}/install-and-setup/upgrading-wso2-is-as-key-manager/upgrading-from-is-km-590-to-5100/#step-a-setup-is-5100-as-a-key-manager).
        -   **Step 5** to upgrade identity component in API-M from 5.5.0 to 5.10.0. You have already done this in Step 2 of [Step A - Setup IS 5.10.0 as a Key Manager]({{base_path}}/install-and-setup/upgrading-wso2-is-as-key-manager/upgrading-from-is-km-590-to-5100/#step-a-setup-is-5100-as-a-key-manager).
