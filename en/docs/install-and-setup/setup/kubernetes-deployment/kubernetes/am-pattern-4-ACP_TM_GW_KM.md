...
4. Deploy GW
```bash
helm install apim-gw wso2/wso2-gw -f https://raw.githubusercontent.com/wso2/helm-apim/76b4e120e675e5ade08edbdc515e1b5a273ef3e2/docs/am-pattern-4-ACP_TM_GW_KM/default_gw_values.yaml
```
