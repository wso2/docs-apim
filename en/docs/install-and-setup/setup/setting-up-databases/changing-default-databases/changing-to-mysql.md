...
!!! note
    ...
    ??? info "Updating tables"
        === "SHARED_DB"
            ```
            ALTER TABLE REG_RESOURCE_COMMENT ADD COLUMN REG_RESOURCE_COMMENT_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (REG_RESOURCE_COMMENT_ID);

            ALTER TABLE REG_RESOURCE_PROPERTY ADD COLUMN REG_RESOURCE_PROPERTY_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (REG_RESOURCE_PROPERTY_ID);

            ALTER TABLE REG_RESOURCE_RATING ADD COLUMN REG_RESOURCE_RATING_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (REG_RESOURCE_RATING_ID);

            ALTER TABLE REG_RESOURCE_TAG ADD COLUMN REG_RESOURCE_TAG_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (REG_RESOURCE_TAG_ID);

            ALTER TABLE UM_SHARED_USER_ROLE ADD COLUMN UM_SHARED_USER_ROLE_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (UM_SHARED_USER_ROLE_ID);
            ```

        === "WSO2AM_DB"
            ```
            ALTER TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT ADD COLUMN IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID);

            ALTER TABLE IDN_OAUTH2_SCOPE_BINDING ADD COLUMN IDN_OAUTH2_SCOPE_BINDING_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (IDN_OAUTH2_SCOPE_BINDING_ID);
            ...
            ALTER TABLE IDN_AUTH_USER_SESSION_MAPPING ADD COLUMN IDN_AUTH_USER_SESSION_MAPPING_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (IDN_AUTH_USER_SESSION_MAPPING_ID);

            ALTER TABLE IDN_OAUTH2_CIBA_REQUEST_SCOPES ADD COLUMN IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID);

            ALTER TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSC ADD COLUMN CM_SP_PURPOSE_PURPOSE_CAT_ASSC_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (CM_SP_PURPOSE_PURPOSE_CAT_ASSC_ID);

            ALTER TABLE CM_PURPOSE_PII_CAT_ASSOC ADD COLUMN CM_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (CM_PURPOSE_PII_CAT_ASSOC_ID);

            ALTER TABLE CM_SP_PURPOSE_PII_CAT_ASSOC ADD COLUMN CM_SP_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (CM_SP_PURPOSE_PII_CAT_ASSOC_ID);

            ALTER TABLE CM_CONSENT_RECEIPT_PROPERTY ADD COLUMN CM_CONSENT_RECEIPT_PROPERTY_ID INTEGER NOT NULL AUTO_INCREMENT, ADD PRIMARY KEY (CM_CONSENT_RECEIPT_PROPERTY_ID);
