...
See the instructions on [configuring the API Gateway]({{base_path}}/monitoring/api-analytics/gateways/configure-synapse-gateway) with the cloud-based analytics solution.
