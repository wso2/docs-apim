...
See the instructions on [configuring the API Gateway]({{base_path}}/monitoring/api-analytics/moesif-analytics/moesif-integration-guide/) with the cloud-based analytics solution.
