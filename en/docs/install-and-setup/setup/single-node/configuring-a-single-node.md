...
See the instructions on [configuring the API Gateway]({{base_path}}/api-analytics/choreo-analytics/getting-started-guide/#step-3-configure-the-gateway) with the cloud-based analytics solution.
