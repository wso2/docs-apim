...
Therefore when required to validate a token, the Classic Gateway uses the in-memory data store and validates the token details. For more information, see [Key Manager]({{base_path}}/get-started/apim-architecture/#key-manager).
