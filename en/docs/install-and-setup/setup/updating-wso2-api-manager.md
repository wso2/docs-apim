...
!!! warning "Re-optimization requirement for distributed deployments"
    ...
    **Important for profiled deployments (Control Plane, Gateway, Traffic Manager, Key Manager)**
    ...
    For more information on profile optimization in distributed deployments, see [Deploying WSO2 API-M in a Distributed Setup]({{base_path}}/install-and-setup/setup/distributed-deployment/deploying-wso2-api-m-in-a-distributed-setup)
