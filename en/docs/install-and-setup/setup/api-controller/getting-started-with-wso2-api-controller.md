...
1.  Download **apictl** based on your preferred platform (i.e., Mac, Windows, Linux).
    ...
    - [For MacOS]({{base_path}}/assets/attachments/learn/api-controller/apictl-4.1.1-macosx-x64.tar.gz)
    - [For Linux 32-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-4.1.1-linux-i586.tar.gz)
    - [For Linux 64-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-4.1.1-linux-x64.tar.gz)
    - [For Windows 32-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-4.1.1-windows-i586.zip)
    - [For Windows 64-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-4.1.1-windows-x64.zip)
...
-   **Response**
    ...
    ```bash
    Version: 4.1.1
    Build Date: 2023-09-08 09:28:32 UTC
    ```
...
1.  Make sure that the WSO2 API Manager (WSO2 API-M) 4.1.0 version is started and that the 4.1.1 version of apictl is set up.     
...
1.  Make sure that the WSO2 API-M 4.1.0 version is started and that the 4.1.1 version of apictl is set up.  
For more information, see [Download and Initialize the apictl](#download-and-initialize-the-apictl).
