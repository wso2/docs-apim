...
-   [Configuring a JDBC User Store]({{base_path}}/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-jdbc-user-store.md)
-   [Configuring a Read-Only LDAP User Store]({{base_path}}/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-read-only-ldap-user-store.md)
-   [Configuring a Read-Write Active Directory User Store]({{base_path}}/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-read-write-active-directory-user-store.md)
-   [Configuring a Read-Write LDAP User Store]({{base_path}}/install-and-setup/setup/configure-userstores/configure-primary-user-store/configuring-a-read-write-ldap-user-store.md)
