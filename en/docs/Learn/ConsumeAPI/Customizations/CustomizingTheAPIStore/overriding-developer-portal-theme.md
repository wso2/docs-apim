...
1.  Download the sample theme here [testTheme.zip]({{base_path}}/assets/attachments/Learn/testTheme.zip) This sample theme is changing the default listing from 'grid' to 'list'.
