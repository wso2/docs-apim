...
-   [Configuring the token exchange](#SAMLExtensionGrant-Configuringthetokenexchange)
...
![]({{base_path}}/assets/attachments/103335282/103335283.png)
...
2.  Click **Main &gt; Identity Providers &gt; Add** .
    ![]({{base_path}}/assets/attachments/103335282/103335288.png)
3.  Provide the following values to configure the IdP:
    ...
    ![]({{base_path}}/assets/attachments/103335282/103335286.png)
...
4.  Sign in to the management console of the Identity Server and click **Main &gt; Service Providers &gt; Add** .
    ![]({{base_path}}/assets/attachments/103335282/103335287.png)
5.  Choose to edit the service provider that you just registered and click **Inbound Authentication Configuration &gt;SAML2 Web SSO Configuration** .
    ![]({{base_path}}/assets/attachments/103335282/103335284.png)6.  Provide the following values to configure the SP and click **Update** :
    ...
    ![]({{base_path}}/assets/attachments/103335282/103335285.png)
...
2.  Download the command-line too from [here]({{base_path}}/assets/attachments/103335282/103335290.zip) and extract the ZIP file.
