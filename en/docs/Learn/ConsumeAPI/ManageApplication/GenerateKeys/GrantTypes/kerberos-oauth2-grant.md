...
![Kerberos-OAuth2 Grant Flow when using WSO2 API-M]({{base_path}}/assets/attachments/103335261/103335265.png)
...
`https://:9443/store                         `
    ...
    4.  Generate the Production Keys.
        ...
        2.  Click on the **Kerberos** checkbox as shown in the screenshot.
            ![]({{base_path}}/assets/attachments/103335261/103335263.png)
...
`https://<Server-Host>:9443/carbon            `
    ...
    3.  Add a new Identity Provider (IDP).
        ...
        ![Adding an IDP in WSO2 API Manager]({{base_path}}/assets/attachments/103335261/103335266.png)
