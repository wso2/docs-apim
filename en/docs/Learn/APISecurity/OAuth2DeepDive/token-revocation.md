...
!!! note
    You can also revoke refresh tokens. For more information, see [Revoking a refresh token]({{base_path}}/Learn/APISecurity/OAuth2DeepDive/GrantTypes/refresh-token-grant/#revoking-a-refresh-token).
