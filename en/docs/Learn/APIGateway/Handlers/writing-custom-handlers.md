...
1.  Open the &lt;APIM\_HOME&gt;/repository/resources/api\_templates/velocity\_template.xml file and copy the following handler beofore &lt;/Handlers&gt;.
...
WSO2 API Manager provides the OAuth2 bearer token as its default authentication mechanism. A sample implementation is [here]({{base_path}}/assets/attachments/103334745/103334748.java) . Similarly, you can extend the API Manager to support any custom authentication mechanism by writing your own authentication handler class.
