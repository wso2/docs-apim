...
3.  Log into the API Developer Portal ( <https://localhost:9443/devportal> ) as a Developer Portal user and open the application with which you subscribed to the API.
    ...
    !!! note
        If you do not have an already created API and an Application subscribed to it, follow [Create and Publish an API](../../../../design-api/create-api/create-a-rest-api) and [Subscribe to an API](../../../../consume-api/manage-subscription/subscribe-to-an-api) to create an API and subscribe to it.
