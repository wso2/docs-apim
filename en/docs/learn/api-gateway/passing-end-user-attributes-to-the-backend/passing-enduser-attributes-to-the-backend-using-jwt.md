...
!!! note
    Enable JWT in all Gateway and Key Manager nodes. For more information on setting up a distributed deployment of API Manager, see [Distributed Deployment of API Manager](../../../../install-and-setup/deploying-wso2-api-manager/distributed-deployment/distributed-deployment-of-api-manager/) .
