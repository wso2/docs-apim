...
1.  Download **API Controller** based on your preferred platform (i.e., Mac, Windows, Linux).
    ...
    - [For MacOS]({{base_path}}/assets/attachments/learn/api-controller/apictl-3.0.2-macosx-x64.tar.gz)
    - [For Linux 32-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-3.0.2-linux-i586.tar.gz)
    - [For Linux 64-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-3.0.2-linux-x64.tar.gz)
    - [For Windows 32-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-3.0.2-windows-i586.zip)
    - [For Windows 64-bit]({{base_path}}/assets/attachments/learn/api-controller/apictl-3.0.2-windows-x64.zip)
...
-   **Response**
    ...
    ```bash
    Version: 3.0.2
    Build Date: 2021-12-03 04:14:42 UTC
    ```
