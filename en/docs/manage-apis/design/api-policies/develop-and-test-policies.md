...
- Familiarity with [policy creation concepts]({{base_path}}/manage-apis/design/api-policies/create-policy/)
...
2. Review the [list of unsupported mediators]({{base_path}}/manage-apis/design/api-policies/create-policy/) to ensure your policy doesn't use restricted mediators:
...
- [Attach a policy]({{base_path}}/manage-apis/design/api-policies/attach-policy/)
