...
![TCP Sender]({{base_path}}/assets/img/tcp/tcpmon-sender-other-usages.png)
...
![Select Proxy]({{base_path}}/assets/img/tcp/tcpmon-proxy-dialog.png)
...
![Advanced settings]({{base_path}}/assets/img/tcp/tcpmon-simulate-slow-connection.png)
