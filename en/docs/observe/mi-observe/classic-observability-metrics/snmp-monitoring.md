...
Following are the OID equivalents of the server manager and transport MBeans, which are described in [JMX Monitoring]({{base_path}}/observe/mi-observe/classic-observability-metrics/jmx-monitoring):
