...
WSO2 API Manager includes a service catalog where developers can register their services in a RESTful manner. Later they can create APIs in API Manager to invoke the registered services. 

These services can be created using WSO2 Integration Studio and other platforms. For an Integration Studio user, the service registration happens automatically when exporting the project as a composite application (CApp).
...
<img src="{{base_path}}/assets/img/integrate/intro/integration-studio.png" alt="Integration Studio" name="Integration Studio" width="700">
