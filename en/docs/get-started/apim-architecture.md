...
[![Basic Architecture]({{base_path}}/assets/img/get_started/architecture/wso2-apim-architecture.png)]({{base_path}}/assets/img/get_started/architecture/wso2-apim-architecture.png)
