...
You have connected WSO2 API Manager with a third-part authorization server. Let's see how WSO2 API Manger creates OAuth clients at Surf OAuth when applications are registered in the API Store. In this guide, we use [Product APIs]({{base_path}}/Develop/ProductAPIs/restful-apis/) to test invoke this process.

1.  Start [WSO2 API Manager]({{base_path}}/InstallAndSetup/InstallationGuide/running-the-product/).
