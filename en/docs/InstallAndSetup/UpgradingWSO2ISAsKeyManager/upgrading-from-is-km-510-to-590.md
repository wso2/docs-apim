...
!!! note
    ...
    -   If you wish to upgrade your APIM environment from **API-M 1.10.0 to 3.0.0**, which is using the **internal** WSO2 Identity Server (**WSO2 IS**) **capabilities**, follow the instructions in [Upgrading API-M from 1.10.0 to 3.0.0](../UpgradingWSO2APIManager/upgrading-from-210-to-300.md).
...
2.  Migrate WSO2 API-M from 1.10.0 to 3.0.0.
    Follow the instructions mentioned in [Upgrading API-M from 1.10.0 to 3.0.0](../UpgradingWSO2APIManager/upgrading-from-1100-to-300.md), but **skip the step 2 - (5)**, which explains how to migrate the WSO2 API-M Identity components.
