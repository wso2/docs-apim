...
Follow the instructions mentioned in [Upgrading API-M from 2.2.0 to 3.1.0](../upgrading-wso2-api-manager/upgrading-from-220-to-310.md), 
but **instead of step 2 - (6)**, which explains how to migrate the WSO2 API-M Identity components, 
follow the WSO2 Identity Server 5.10.0 documentation to migrate the WSO2 Identity Server (WSO2 IS) from version 5.5.0 to 5.10.0.
[Migrate the WSO2 Identity Server (WSO2 IS) from version 5.5.0 to 5.10.0](https://is.docs.wso2.com/en/5.10.0/setup/migrating-to-5100/)
