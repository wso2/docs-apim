...
!!! warning
    ...
    - **[WSO2 recommends that you use the Publisher v1 REST APIs]({{base_path}}/develop/product-apis/publisher-apis/publisher-v1/guide/)** as it up to date and has support for the latest WSO2 API Manager 3.2.0 features.
