...
2. Click **New** to start defining a new Siddhi application. A new file opens as shown below.
    ...
    ![New Siddhi File](../../assets/img/streaming/Creating-Siddhi-Applications/New_Siddhi_File.png)
                    ...
                    <div class="content-wrapper">
                       ...
                       <ol>
                          <li>
                             ...
                             <p><img src="../../../assets/img/streaming/Creating-Siddhi-Applications/Operator_Finder.png" /></p>
                          </li>
                          <li>
                             <p>Move the cursor to the location in the Siddhi application where you want to add the source.<br />
                                <img src="../../../assets/img/streaming/Creating-Siddhi-Applications/MoveCursor.png" />
                             </p>
                          </li>
                          <li>
                             <p>Search for the required transport type. Once it appears in the search results, click the <strong>Add to Source</strong> icon on it.<br />
                                <img src="../../../assets/img/streaming/Creating-Siddhi-Applications/Search_And_Add_Extension.png"/>
                             </p>
                          </li>
                          <li>
                             <p>Similarly, search for the mapping type you want to include in the source configuration, and add it.</p>
                             <p><img src="../../../assets/img/streaming/Creating-Siddhi-Applications/Search_And_Add_Map_Extension.png"></p>
                          </li>
                          <li>
                             <p>The source annotation is now displayed as follows. You can add the other properties as required, and save your changes.<br />
                                <img src="../../../assets/img/streaming/Creating-Siddhi-Applications/Selected_Extensions.png">
                             </p>
                          </li>
                       </ol>
                    </div>
...
6.  To see a graphical view of the event flow you defined in your Siddhi
    ...
    ![Switch to Design View](../../assets/img/streaming/Creating-Siddhi-Applications/Design_View.png)
    
    The event flow is displayed as follows.  
    
    ![Siddhi Application in Design View](../../assets/img/streaming/Creating-Siddhi-Applications/Siddhi_Application_Design_View.png)
...
4.  To define the input stream into which the events to be processed via
    ...
    ![Stream Icon](../../assets/img/streaming/Creating-Siddhi-Applications/Stream_Icon.png)

    Once the stream component is added to the grid, move the cursor over
    it, and then click on the settings icon as shown below.

    ![Stream Settings](../../assets/img/streaming/Creating-Siddhi-Applications/Stream_Settings.png)

    As as result, the Stream Configuration form opens as follows.  
    ![Stream Configuration form](../../assets/img/streaming/Creating-Siddhi-Applications/Stream_Configuration_Form.png)
    ...
    3.  Click **Submit** to save the new stream definition. As a result,
        ...
        ![New stream added to the grid](../../assets/img/streaming/Creating-Siddhi-Applications/Stream_Component.png)
...
6.  To add the source from which events are received, drag and drop the
    ...
    ![Source Icon](../../assets/img/streaming/Creating-Siddhi-Applications/Source_Icon.png) 
    ...
    **SweetProductionStream** input stream component by dragging the
    ...
    follows.  
    ![Source Configuration form](../../assets/img/streaming/Creating-Siddhi-Applications/Source_Configuration.png)
...
7.  To add a query that defines the execution logic, drag and drop the
    ...
    ![Projection Query Icon](../../assets/img/streaming/Creating-Siddhi-Applications/Projection_Query_Icon.png)  
...
9.  To add a sink to publish the output events that are directed to the `ProductionAlertStream` output stream, drag and
    ...
    ![Sink icon](../../assets/img/streaming/Creating-Siddhi-Applications/Sink_Icon.png) <br/>
    ...
    **Sink Configuration** form. Then enter information as follows.  
    ...
    ![Configuring the sink](../../assets/img/streaming/Creating-Siddhi-Applications/Sink_Configuration.png)  
...
10. To align the Siddhi components that you have added to the grid,
    ...
    ![Aligned Siddhi components](../../assets/img/streaming/Creating-Siddhi-Applications/Siddhi_Application_Design_View.png)
    
11. Click **Source View**. The siddhi application is displayed as follows.  

    ![Source view](../../assets/img/streaming/Creating-Siddhi-Applications/Siddhi_Application_Source_View.png)
...
12. Click **File** and then click **Save as**. The **Save to Workspace** dialog box appears. In the **File Name** 
    ...
    ![Saving the Siddhi application](../../assets/img/streaming/Creating-Siddhi-Applications/Save_Siddhi_Application.png)
