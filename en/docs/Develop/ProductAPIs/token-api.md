...
!!! note
    You can also revoke refresh tokens. For more information, see [Revoking a refresh token](../../Learn/APISecurity/OAuth2DeepDive/GrantTypes/refresh-token-grant.md#revoking-a-refresh-token) .
