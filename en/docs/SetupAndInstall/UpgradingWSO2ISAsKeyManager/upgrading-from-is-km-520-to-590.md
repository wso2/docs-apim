...
2.  Migrate WSO2 API-M from 2.0.0 to 3.0.0.
    Follow the instructions mentioned in [Upgrading API-M from 2.0.0 to 3.0.0](../UpgradingWSO2APIManager/upgrading-from-200-to-300.md), but **skip the step 2 - (5)**, which explains how to migrate the WSO2 API-M Identity components.
