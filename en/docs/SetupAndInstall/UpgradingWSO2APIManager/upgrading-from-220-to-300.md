...
!!! note
    If you are using WSO2 Identity Server (WSO2 IS) as a Key Manager, follow the instructions in [Upgrading WSO2 IS as the Key Manager to 5.9.0](../UpgradingWSO2ISAsKeyManager/upgrading-from-is-km-550-to-590.md).
...
3.  To start the migration process, run the respective migration script based on your environment.
    ...
    ??? note "Windows"
        !!! note "Windows - Super Tenant"
            ...
            Where `<API-M_2.6.0_HOME>` can be, for example, `/Users/user12/Documents/wso2am-3.0.0`.
