...
1. Navigate to the [Okta sign up page](https://developer.okta.com/signup/) and sign up to **Workforce Identity Cloud**. We have created an account in **Developer Edition** for this.
