...
3. Download [notification.event.handlers-2.0.3.jar]({{base_path}}/assets/attachments/administer/wso2is.notification.event.handlers-2.0.3.12.jar) and add it to `<IS_HOME>/repository/components/dropins`
