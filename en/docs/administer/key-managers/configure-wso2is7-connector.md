...
3. Download [notification.event.handlers-2.0.4.jar]({{base_path}}/assets/attachments/administer/wso2is.notification.event.handlers-2.0.4.6.jar) and add it to `<IS_HOME>/repository/components/dropins`.
...
9. Under **Connector Configurations**, select the authentication method for communication between API Manager and WSO2 Identity Server 7.x. Two authentication options are available:
...
10. Configure the connector settings based on your selected authentication method:
