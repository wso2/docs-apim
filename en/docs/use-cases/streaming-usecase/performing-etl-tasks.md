...
WSO2 Streaming Integrator provides the Source View, Design View and the Wizard View for application design. For more information, see [Streaming Integrator Tooling Overview]({{base_path}}/develop/streaming-apps/streaming-integrator-studio-overview.md).
...
To learn how to design an ETL application via the Wizard view, see the [Creating an ETL Application via SI Tooling tutorial]({{base_path}}/streaming-tutorials/creating-etl-application-via-tooling.md).
...
You can set up the pre-configured dashboards in Grafana. For instructions to set up these dashboards and visualize your ETL statistics, see [Monitoring ETL Statistics with Grafana]({{base_path}}/admin/viewing-dashboards.md).
...
- [Performance Analysis Results - Performing ETL Tasks]({{base_path}}/ref/performance-analysis-results.md/#performing-etl-tasks)
