...
3. [Create a Siddhi application]({{base_path}}/develop/streaming-apps/creating-a-siddhi-application.md) as follows and [deploy it in the Streaming Integrator server]({{base_path}}/develop/streaming-apps/deploying-streaming-applications.md).
