...
!!! tip "Before you begin:"
    - [Start WSO2 Streaming Integrator server]({{base_path}}/setup/installing-si-in-vm.md##starting-the-si-server).<br/><br/>
    - [Start Streaming Integrator Tooling]({{base_path}}/develop/streaming-apps/streaming-integrator-studio-overview.md#starting-streaming-integrator-tooling).
