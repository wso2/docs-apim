...
The examples here use the `StarWarsAPI` GraphQL API, which was created in [Create a GraphQL API]({{base_path}}/manage-apis/design/create-api/create-graphql-api/create-a-graphql-api/).
