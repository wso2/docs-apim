...
2. Make a copy of the `en.json` file and rename it based on the locale code.
     ...
     Rename the copy of the `<APIM_HOME>/repository/deployment/server/webapps/devportal/site/public/locales/en.json` file to `fr.json`.
...
1. Open the `<APIM_HOME>/repository/deployment/server/webapps/devportal/src/main/webapp/site/public/theme/defaultTheme.json` file.
