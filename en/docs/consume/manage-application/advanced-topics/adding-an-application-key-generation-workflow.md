...
4.  Sign in to the API Developer Portal `https:// host:9443/devportal` as a Developer Portal user and open the application with which you subscribed to the API. Click **Applications** and click on an **ACTIVE** application.
