...
!!! note
    If you are using custom rate limiting policies in this setup, please refer [Custom Rate Limiting with Distributed Throttling]({{base_path}}/design/rate-limiting/advanced-topics/custom-throttling/#custom-rate-limiting-with-distributed-throttling).
