...
5.  Click **Save** and re-publish the API.
     ...
     For more details on creating and publishing an API, see [Create an API]({{base_path}}/design/create-api/create-a-rest-api) and [Publish an API]({{base_path}}/deploy-and-publish/publish-on-dev-portal/publish-an-api).
