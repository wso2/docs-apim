...
!!! note
    The expiration time is defined in seconds. The changes that you do here will be applied only to the new applications that you create.

For more information about changing the default token expiration time, see [Changing the Default Token Expiration Time]({{base_path}}/consume/manage-application/generate-keys/obtain-access-token/changing-the-default-token-expiration-time).
