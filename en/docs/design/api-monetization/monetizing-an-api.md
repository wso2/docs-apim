...
4. Optionally, configure WSO2 API Manager to work with Choreo Analytics.
    ...
    !!! note
        For instructions on configuring API Manager with ELK Analytics, see [Monetization Support via Elasticsearch]({{base_path}}/design/api-monetization/monetizing-an-api/#monetization-support-via-elasticsearch)
