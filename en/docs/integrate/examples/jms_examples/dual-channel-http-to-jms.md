...
To invoke this service, the address URI of this proxy service is defined as `         http://tharsanan:8290/services/SMSSenderProxy        `. Send a POST request to the above address URI with the following payload:
