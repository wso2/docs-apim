...
If the previous example on [JMS to HTTP]({{base_path}}/install-and-setup/setup/mi-setup/changing_default_ports) is also configured, it will pick the message from queue and send it to the stockquote proxy.
