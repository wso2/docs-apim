...
1.  Right-click the **Data Service Config** module in the project
    ...
    <img src="{{base_path}}/assets/img/integrate/tutorials/data_services/new-data-service.png" width="700"> 
...
1.  Click **Queries** to expand the section. 
    ...
    <img src="{{base_path}}/assets/img/integrate/tutorials/data_services/query_expanded.png)" width="70%">

2.  Click **Add New** to open the **Add Query** page.

    <img src="{{base_path}}/assets/img/integrate/tutorials/data_services/add_query.png" width="70%">
...
1.  Click **Input Mappings** to expand the section. 
    ...
    <img src="{{base_path}}/assets/img/integrate/tutorials/data_services/input_mapping_expanded.png" width="70%">
...
<img src="{{base_path}}/assets/img/integrate/tutorials/data_services/input_mappings.png" width="70%">
...
1.  Click **Operations** to expand the section.
    ...
    <img src="{{base_path}}/assets/img/integrate/tutorials/data_services/new-operataion.png" width="70%">

2.  Click **Add New** to add a SOAP Operation for your data service.

	<img src="{{base_path}}/assets/img/integrate/tutorials/data_services/add-operation.png" width="70%">
...
1.  Click **Resources** to expand the section.
	...
	<img src="{{base_path}}/assets/img/integrate/tutorials/data_services/resource_expanded.png" width="70%">

2.	Click **Add New** to add a new resource.

	<img src="{{base_path}}/assets/img/integrate/tutorials/data_services/create_resource.png" width="70%">
