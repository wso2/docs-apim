...
1. [Configure API Logs using Devops REST API]({{base_path}}/monitoring/observability/logs/monitoring-api-logs/#configure-api-logs-using-devops-rest-api)
2. [Configure API Logs using API Controller (APICTL)]({{base_path}}/monitoring/observability/logs/monitoring-api-logs/#configure-api-logs-using-api-controller-apictl)
