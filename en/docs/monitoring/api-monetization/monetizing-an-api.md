...
1. Connect WSO2 API Manager to the billing engine.
    ...
    1. Download the following JARs and place them in the `<API-M_HOME>/repository/components/lib` directory.
        ...
        - [org.wso2.apim.monetization.impl-1.7.1.jar](https://github.com/wso2-extensions/wso2-am-stripe-plugin/releases/download/v1.7.1/org.wso2.apim.monetization.impl-1.7.1.jar)
    ...
    2. Deploy the Stripe service WAR.
        ...
        Download [api#am#stripe.war](https://github.com/wso2-extensions/wso2-am-stripe-plugin/releases/download/v1.7.1/api.am.stripe.war).
