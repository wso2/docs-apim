...
invoke the [WebSocket API]({{base_path}}/api-design-manage/design/create-api/create-streaming-api/create-a-websocket-streaming-api.md) using the **wscat** WebSocket client.
