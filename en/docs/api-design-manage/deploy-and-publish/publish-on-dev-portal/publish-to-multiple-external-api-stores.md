...
10. Click on the newly created or existing API.
    ...
    ![List External Developer Portal]({{base_path}}/assets/img/learn/external-dev-portals.png)
...
11. Select the Developer Portal that you want to publish to (in this case, `DeveloperPortal2`) and click **Save**.
     ...
     ![Publish to external Developer Portal]({{base_path}}/assets/img/learn/publish-to-external-devportal.png)
