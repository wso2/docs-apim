...
!!! note
    For more details on the API lifecycle stages, see [API lifecycle]({{base_path}}/api-design-manage/design/lifecycle-management/api-lifecycle/).
...
2.  Click on the API that you created in the [previous tutorial]({{base_path}}/api-design-manage/design/api-versioning/create-a-new-api-version/) (e.g., `PizzaShackAPI 2.0.0`).
