...
```
 ...
 <ul><li><a href="{{base_path}}/api-design-manage/design/endpoints/resiliency/endpoint-timeouts">Endpoint Timeouts</a>
 </li>
<li><a href="{{base_path}}/api-design-manage/design/endpoints/resiliency/prevent-api-suspension">Prevent API Suspension</a></li></ul></p>
 </div>
