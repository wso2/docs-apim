...
Invoke APIs and open <a href="https://console.choreo.dev/insights/overview" onclick="appInsights.trackEvent({name: 'apim-docs-get-started-view-api-analytics-dashboard',properties: { utm_source: 'APIM_docs' }});">Choreo Insights</a> to view the dashboards.
