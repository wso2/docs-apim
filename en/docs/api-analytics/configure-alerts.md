...
One of the most useful features in API cloud analytics is alerting. You can configure several types of alerts and receive alerts either within the portal. These alerts allow you to proactively monitor your API ecosystem and take corrective measures for any abnormalities you find.
