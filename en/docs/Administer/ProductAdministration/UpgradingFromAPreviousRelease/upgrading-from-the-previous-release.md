...
The following information describes how to upgrade your API Manager server **from APIM 1.8.0/1.9.0/1.9.1/1.10.0/2.0.0/2.1.0/2.2.0/2.5.0to 2.6.0** .
...
1.  Configure the statistics related datasources for WSO2 API Manager Analytics.
    ...
    -   -   The first datasource points to the **previous API-M version's AM\_DB datasource.**
        ...
        -   The second datasource points to the **WSO2Data Analytics (WSO2DAS) based previous datasource WSO2AM\_STATS\_DB for statistics** .
...
Follow the instructions below to upgrade your WSO2 API Manager server **from APIM 1.10.0to 2.6.0** .
