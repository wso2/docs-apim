...
[Deploy the API](../../../manage-apis/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api/) in order to make the API available in the respective Gateway.

## Step 4 - Test the API via the Publisher

Once deployed to the Gateway, you can [test the REST type APIs via the Publisher Portal](../../../manage-apis/design/create-api/create-rest-api/test-a-rest-api/).
...
!!! important
    ...
    - Skip this step if you have [disabled security](../../../manage-apis/design/api-security/api-authentication/disable-security/) for all the resources in the API.
