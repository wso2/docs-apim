...
2. Select `HTTP Referrers (Web Sites)` and add the referrers in the text input as shown below and generate the key.
   ...
   [![HTTP Referer Restricted API key](https://apim.docs.wso2.com/en/4.3.0/assets/img/learn/http-referer-api-key.png)](https://apim.docs.wso2.com/en/4.3.0/assets/img/learn/http-referer-api-key.png)
