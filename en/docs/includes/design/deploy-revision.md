...
!!! note
    ...
    [![Deployment status acknowledgement]({{base_path}}/assets/img/design/revision/revision-deployment-acknowledgement.png)]({{base_path}}/assets/img/design/revision/revision-deployment-acknowledgement.png)
