...
4. Run `npm start` to start the server.
    ...
    [![CLI output](/en/4.7.0/assets/img/learn/cli-output.png){: style="width:45%"}](/en/4.7.0/assets/img/learn/cli-output.png)
...
2. Click **Create API**, go to **GraphQL** and then click **Create a GraphQL API**.
     ...
     [![Create GraphQL Schema Option](/en/4.7.0/assets/img/learn/create-graphql-schema-option.png)](/en/4.7.0/assets/img/learn/create-graphql-schema-option.png)

3. Import the schema by dragging and dropping the file or by uploading the file, and click **Next**.

       Let's use the [StarWarsAPI schema definition](/en/4.7.0/assets/attachments/learn/schema_graphql.graphql) to create the schema file. 
      ...
      [![Import a GraphQL schema by adding a file](/en/4.7.0/assets/img/learn/import-graphql-schema-via-file.png){: style="width:80%"}](/en/4.7.0/assets/img/learn/import-graphql-schema-via-file.png)
...
4. Enter the GraphQL API related details and click **Create**.
    ...
    [![Add GraphQL API details](/en/4.7.0/assets/img/learn/create-graphql-api-details.png){: style="width:75%"}](/en/4.7.0/assets/img/learn/create-graphql-api-details.png)
...
5. Optionally, modify the existing GraphQL schema definition.
    ...
    2. Click **Download Definition**.
         ...
         [![Add schema definition](/en/4.7.0/assets/img/learn/download-schema-definition.png){: style="width:80%"}](/en/4.7.0/assets/img/learn/download-schema-definition.png)
...
6. Update the GraphQL API operations as required.
    ...
    1. Click **Show More** under the **Operations** section in the **Overview** page to navigate to the operations page.
         ...
         [![GraphQL API operations](/en/4.7.0/assets/img/learn/operations.png)](/en/4.7.0/assets/img/learn/operations.png)  
    ...
    2. Update the operations as required.
        ...
        1. **Create scopes**.
            ...
            1. Click **Local Scopes**, and then click **Create Scopes**.
                ...
                [![Add a scope page](/en/4.7.0/assets/img/learn/add-scope.png)](/en/4.7.0/assets/img/learn/add-scope.png)
            ...
            2. Enter the required details.
                   ...
                   <p class="admonition-title">Note</p>
                   <p> 
                   <ul><li>The role that you enter <b>should be a valid role that already exists in WSO2 API Manager</b>. Make sure to assign the role to the user. </li><li>For more information, see <a href="/en/4.7.0/administer/managing-users-and-roles/managing-users/">Adding Users</a> and <a href="/en/4.7.0/administer/managing-users-and-roles/managing-user-roles/">Adding User Roles</a>.</li></ul>
                   </p>
                   </div>
                   ...
                   [![Create a scope](/en/4.7.0/assets/img/learn/create-scope.png)](/en/4.7.0/assets/img/learn/create-scope.png)

            3. Press `Enter` to add each role. 

            4. Click **Save**.

                 [![List of added scopes](/en/4.7.0/assets/img/learn/starwars-scope-list.png)](/en/4.7.0/assets/img/learn/starwars-scope-list.png)
         ...
         2. **Define the operation level configurations**.
            ...
            2. Click **Operation Level** to apply Rate Limiting for operations.
                ...
                [![Update GraphQL API operations](/en/4.7.0/assets/img/learn/update-operations.png)](/en/4.7.0/assets/img/learn/update-operations.png) 
            ...
            4. Click **Save**.
                 ...
                 [![Scope list](/en/4.7.0/assets/img/learn/scope-list.png)](/en/4.7.0/assets/img/learn/scope-list.png)
