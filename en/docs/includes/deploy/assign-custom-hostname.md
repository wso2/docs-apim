...
3.  Click on the API to edit its configurations.
     ...
     [![Edit the API](https://apim.docs.wso2.com/en/4.2.0/assets/img/includes/deploy/select-api.png)](https://apim.docs.wso2.com/en/4.2.0/assets/img/includes/deploy/select-api.png)

4.  Click **Deployments**.

5.  Select the newly created Gateway environment, Virtual Host (foods.com), and a Revision.

     [Create a new revision](https://apim.docs.wso2.com/en/4.2.0/design/create-api/create-api-revisions/) if no revisions exist.
