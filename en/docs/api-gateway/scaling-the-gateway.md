...
For more information, see [Key cache]({{base_path}}/install-and-setup/setup/advance-configurations/configuring-caching.md#key-cache) in the WSO2 API Manager documentation.
