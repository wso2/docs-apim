...
![Hybrid Gateway]({{base_path}}/assets/img/learn/hybrid-gw.png)
...
![Production and sandbox gateways]({{base_path}}/assets/img/learn/production-sandbox-gws.png)
...
![Multi-region Gateway]({{base_path}}/assets/img/learn/multi-reigion-gw.png)
