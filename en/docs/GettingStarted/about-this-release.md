...
For more information on WSO2 API Manager, see the [overview in the WSO2 API Manager 3.0.0 documentation]({{base_path}}/GettingStarted/overview/) and go to the [product page on WSO2 API Manager on the WSO2 website.](https://wso2.com/api-management/)
...
- **[JWT Authentication]({{base_path}}/Learn/APISecurity/OAuth2/AccessTokenTypes/jwt-tokens)**
...
- **[GraphQL API support]({{base_path}}/Learn/DesignAPI/CreateAPI/create-a-graphql-api)**
...
- **[Bot Detection]({{base_path}}/Learn/APISecurity/ThreatProtection/bot-detection)**
...
- **[API Product]({{base_path}}/Learn/DesignAPI/CreateAPIProduct/api-product-overview)**
...
- **[API Key]({{base_path}}/Learn/APISecurity/APIAuthentication/secure-apis-using-api-keys)**
