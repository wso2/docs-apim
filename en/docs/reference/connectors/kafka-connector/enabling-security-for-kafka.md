...
Follow the sample scenario in [Kafka configuration documentation]({{base_path}}/reference/connectors/kafka-connector/kafka-connector-config.md), and send the following message to the Kafka broker:
