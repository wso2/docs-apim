concepts/message-processing-units/#classification-of-mediators# EJB Mediator
...
!!! Info
    The EJB mediator is a [content-aware]({{base_path}}/reference/mediators/about-mediators/#classification-of-mediators) mediator.
