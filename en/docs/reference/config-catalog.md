...
## API-M Moesif Analytics configurations
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <span class="badge-required">Required</span>
                            <p>
                                Top-level configuration for publishing analytics to Moesif. Supported from WSO2 API Manager 4.5.0 Update Level 11 onwards.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    <div>
                                        ...
                                        <div class="param-possible">
                                            <span class="param-possible-values">Possible Values: <code>moesif</code></span>
                                        </div>
                                    </div>
                                    <div class="param-description">
                                        <p>Analytics provider type. Set this to &#39;moesif&#39; to publish analytics to Moesif.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <span class="badge-required">Required</span>
                            <p>
                                Moesif specific properties. Applicable only when the analytics type is 'moesif'.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Moesif API key used to authenticate ingestion.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Base URL of the Moesif ingestion endpoint.</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
