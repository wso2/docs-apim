...
!!! Note
	An [external user store]({{base_path}}/install-and-setup/setup/mi-setup/user_stores/setting_up_a_userstore/) should be configured for the Micro Integrator in order to use these security implementation.
