...
-   Identify potential [error-prone situations and define corresponding error messages]({{base_path}}/administer/logging-and-monitoring/logging/configuring-logging/) .
