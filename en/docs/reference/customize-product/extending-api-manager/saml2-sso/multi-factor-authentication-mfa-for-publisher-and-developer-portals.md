...
1.  Configure Single Sign-On (SSO) with WSO2 Identity Server. 
     ...
     For more information, see [Configuring Identity Server as IDP for SSO]({{base_path}}/reference/customize-product/extending-api-manager/saml2-sso/configuring-identity-server-as-idp-for-sso.md).
