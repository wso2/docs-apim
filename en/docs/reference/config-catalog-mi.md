                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <span class="badge-required">Required</span>
                            <p>
                                This configuration header is required for configuring <a href='{{base_path}}/install-and-setup/setup/mi-setup/configuring_proxy_servers/#configuring-proxy-profiles-in-wso2-micro-integrator'>secured HTTP proxy profiles</a> when you use multiple (secured) proxy servers to route messages to different endpoints.
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
