...
The following properties can be configured when [creating a WSO2 MB Message Store]({{base_path}}/integrate/develop/creating-artifacts/creating-a-message-store/).
