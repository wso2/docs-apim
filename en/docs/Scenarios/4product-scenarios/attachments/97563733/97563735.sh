...
$JAVA_HOME/bin/java -Dcipher.text.properties.file=repository/conf/security/cipher-text.properties -Dcipher.tool.properties.file=repository/conf/security/cipher-tool.properties -classpath "$CARBON_CLASSPATH" org.wso2.ciphertool.CipherTool $*
