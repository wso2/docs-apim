                        ...
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Type of trace exporter (e.g: azure, jaeger, zipkin)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="doc-wrapper">
                    <div class="mb-config">
                        <div class="config-wrap">
                            ...
                            <span class="badge-required">Required</span>
                            <p>
                                Configurations specific to tracer configured in `tracing.type`
                            </p>
                        </div>
                        <div class="params-wrap">
                            <div class="param">
                                ...
                                <div class="param-info">
                                    <div>
                                        ...
                                        <div class="param-default">
                                            <span class="param-default-value">Default: <code>http://jaeger:14268/api/traces</code></span>
                                        </div>
                                        
                                    </div>
                                    <div class="param-description">
                                        <p>Tracing data receiver endpoint. Applicable only for Jaeger and Zipkin tracers</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Azure App Insights connection string</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
                                ...
                                <div class="param-info">
                                    ...
                                    <div class="param-description">
                                        <p>Reference name for the configured tracer&#39;s instrumentation</p>
                                    </div>
                                </div>
                            </div><div class="param">
                                <div class="param-name">
